...
## This website or tuufless?
Tuufless, or basically any other source that you can use. The target audience for this website is focused on players who either need references in order to improve their own overall skill level, or players who can't raid with just a video/raidplan reference. This website is slow to update as a result, so keep that in mind if you're ever enganging in new content that only has been recently released.