...
- For clarity, the melee DPS will be referred to as D1 while the ranged DPS will be D2.
...
There are multiple macros going around in Mana, but they all essentially point to the same strategy with minor differences in clockspots.
...
### English (OCE Strat)
    ...
    ■ Boss 3 ---------------------------------------------------------------------------
    Brand 1 → N: Melee | S: Ranged | Close: DPS | Far: Support
    Brand 3 → Orange North | West: Out
                          Blue South       | East: In


### Japanese (Mana PF Strat version 1)
...
### Japanese (Mana PF Strat version 2)
    ...
    ■2ボス───────────────────
    西：頭割り　｜鎖　　西：Ｈ遠　東：T近
    東：連呪　　｜鎖塔　12時から時計回りT>近>遠>H
    ■3ボス───────────────────
    呪具1：北:TH　南:近遠　(デバフ被ったらT遠、H近)
    呪具2：南西  or 北東
    呪具3：脳死法　北から赤←、赤→、青→、青←
    呪具4：基本散開X字
    呪具5：基本散開X字
...
### Japanese (Mana PF Strat Version 3)
