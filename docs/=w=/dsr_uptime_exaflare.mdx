...
- The braindead way, which induces downtime but works for all patterns.
...
<table>
    <tr>
        ...
        <td width='50%' align='center'><strong>South exaflare is diagonal. <br/>Dodge into the safe one and stay.</strong></td>
        <td width='25%'><img src={north2} /></td>
    </tr>
    <tr>
...
## Forced downtime pattern
There does exist a theoretical forced downtime pattern, but I have never seen it so far. 

<table>
    <tr>
        <td width='25%'><img src={downtime1} /></td>
        <td width='50%' align='center'><strong>If you do encounter this, then you need to be creative if you want your uptime.</strong></td>
        <td width='25%'><img src={downtime2} /></td>
    </tr>
</table>