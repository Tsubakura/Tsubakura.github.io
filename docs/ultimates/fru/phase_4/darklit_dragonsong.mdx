...
After defeating Gaia, Shiva Mitron will reappear either north or south of the arena, opposite where Gaia was. While Gaia disappears, Shiva will now cast <strong>Materialization</strong> and spawn the <strong>Fragment of Fate</strong> at the northern part of the map. The crystal will not spawn if you destroyed any of the dark crystals during the intermission in phase 2.
...
Your goal in phase 4 is simple, you must defeat both Gaia and Shiva without the <strong>Fragment of Fate</strong> shattering to pieces. If the fragment did not spawn or if it got destroyed anytime during phase 4, then clearing this phase will summon Eden instead who will then wipe the party.
