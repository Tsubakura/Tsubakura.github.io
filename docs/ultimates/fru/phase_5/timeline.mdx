...
<table>
    ...
    <tr>
        <th>Paradise Lost</th>
        <td>Enrage. The party will gain an extra 1.5 LB gauge once the enrage cast is halfway done, which will most likely grant your party a LB3 usage. The window to use the melee LB3 is very short, so prioritize using it as soon as possible when available.</td>
    </tr>
</table>