...
While each datacenter follows the same common sense (don't be an asshole and don't trap), each datacenter has their own culture and conventions when it comes to conducting raids.
...
A typical JP waymark has the 1 start at northwest when the waymarks are placed in a clock position. Below is an example of P9S.
...
NA is a North American FFXIV datacenter and the datacenter everyone believes has the best raiders of NA for some reason. The language used in Aether while raiding is primarily English.
...
Elemental is a Japanese FFXIV data center and it is home to the English-speaking raiders who live in the Asia and Oceania regions. Elemental does have Japanese players, but the majority of the PF are English-speaking.
...
<ul>
    <li>Elemental mainly follows <a href="https://tuufless.github.io/FFXIV-Elemental-Raid-Macros/">Tuufless</a>. You can join his discord <a href="https://discord.gg/WEzhVHwAU6">here</a>. Reminder, he does <b>not</b> make the strategies, he only puts up what is popular.</li>
