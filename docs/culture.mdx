...
A typical JP waymark has the 1 start at northwest when the waymarks are placed in a clock position. Below is an example of P9S if game8 properly follows the JP convention.
