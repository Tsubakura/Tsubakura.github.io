...
- While raiding in Mana, everyone in the party is expected to be able to at least communicate in Japanese to some decree, even if it is basic.
...
<ul>
    ...
    <li>JP strategies prefers splitting the map between north (G1) and south (G2) halves. If its unfeasible, they will split it west (G1) and east (G2) instead.</li>
...
<ul>
    ...
    <li>NA strategies prefers splitting the map between west (G1) and east (G2) halves. If its unfeasible, they will split it north (G1) and south (G2) instead.</li>
...
- Elemental raiders will assume you will own up to your own mistake, whether you say "my bad" or not.
  - If you're struggling with a mechanic or need advice, you are expected to take the initiative to ask the question yourself.
- Ragequitting (leaving without saying anything) is not considered rude, but will leave a bad impression.
