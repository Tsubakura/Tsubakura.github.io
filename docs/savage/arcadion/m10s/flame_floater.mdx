...
After resolving <strong>Alley-oop Inferno</strong>, immediately have the MT drag the boss out of the fire if hes currently standing inside it. The boss will use <Raidwide>Cutback Blaze</Raidwide>, which is a weak raidwide by itself but it will also **target one random player** and cover the whole 330° degrees in the direction of the targeted player with fire, leaving only the area behind him safe. 

You do not want randomness to happen here, so have everyone stack in the corner of the fire puddles to bait the safe zone into the open area. 
