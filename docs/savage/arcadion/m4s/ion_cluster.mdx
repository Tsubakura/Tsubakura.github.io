...
<KittenAsset path='m4s/ion_cluster_cannon.webm' wrapper='div' />
...
<table width='80%'>
    ...
    <tr>
        ...
        <td><center><strong>Spinning Conductor</strong></center><br />A small AoE will explode around you, which inflicts a magic vulnerability. This is the only debuff that doesn't allow the player to take a direct hit from the protean laser. The party cannot receive this debuff in combination with either <b>Roundhouse Conductor</b> or <b>Proximate Current</b>.</td>
...
<KittenAsset path='m4s/ion_cluster_example1.webm' wrapper='div' />
