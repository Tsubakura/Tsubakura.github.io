...
There exists a simulator which you can use to verify whether you understand all the steps taken in the mechanic to resolve <strong>Sunrise Sabbath</strong>. You can access this simulator through the following link: http://cupnoodle.moe/sunrise.htm
...
<table>
    ...
    <tr>
        <td><KittenAsset path='m4s/sunrise_sabbath_example1.webm' /></td>
        <td><KittenAsset path='m4s/sunrise_sabbath_example2.webm' /></td>
    </tr>
</table>
