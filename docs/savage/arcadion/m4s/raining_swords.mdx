...
sidebar_label: Raining Swords (Chain Lightning)
hide_title: false
...
<KittenAsset path='m4s/raining_swords_towers.webm' wrapper='div' />
...
<KittenAsset path='m4s/raining_swords_chain_lightning_part1.webm' wrapper='div' />
<br /><br />
...
<KittenAsset path='m4s/raining_swords_chain_lightning_part2.webm' wrapper='div' />

The boss will immediately use <strong>Tail Thrust</strong> once the arena has been repaired. Resolve the knockbacks if its blue, or dodge them if its red. This attack is then followed up by <Tankbuster>Mustard Bomb</Tankbuster>, a mechanic you've seen before at the start of the 2nd phase.

If the MT has not committed his/her invuln yet, then this is a good time to use it to mitigate the first hit of the <Tankbuster>Mustard Bomb</Tankbuster>. Doing so will free up your mitigations, which you can use freely between <strong>Chain Lightning</strong> and <strong>Sunrise Sabbath</strong>, which is the next major mechanic. You only need to invuln the initial hit, as the timing is too tight to also invuln the secondary hit. 