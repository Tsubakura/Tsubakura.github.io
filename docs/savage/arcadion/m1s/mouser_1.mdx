...
<table>
    ...
    <tr>
        <td><KittenAsset path='m1s/mouser_pound.png' /></td>
        <td><KittenAsset path='m1s/mouser_uppercut.png' /></td>
    </tr>
</table>
...
<KittenAsset path='m1s/mouser_1.webm' wrapper='div' />
...
<KittenAsset path='m1s/mouser_shockwave.webm' wrapper='div' />
