...
<KittenAsset path='m3s/tag_team_2.webm' wrapper='div' />

After resolving the 2nd Tag Team, the boss will cast either <strong>Octoboom Dive</strong> or <strong>Quadroom Dive</strong>, followed by a <Raidwide>Brutal Impact</Raidwide> and a <Tankbuster>Knuckle Sandwich</Tankbuster>. For reference, this <Tankbuster>Knuckle Sandwich</Tankbuster> is commonly invulned by the MT due to the amount of times it hits at this point.