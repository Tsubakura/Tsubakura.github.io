...
<KittenAsset path='m7s/waymark1.png' wrapper='div' width='60%' />

</TabItem>

<TabItem value="Phase 2" label="Phase 2">

<KittenAsset path='m7s/waymark2.png' wrapper='div' width='60%' />

</TabItem>

<TabItem value="Phase 3" label="Phase 3">

<KittenAsset path='m7s/waymark3.png' wrapper='div' width='60%' />
