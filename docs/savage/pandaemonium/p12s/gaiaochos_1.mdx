...
<KittenAsset path='p12s/palladian_grasp_jp.webm' wrapper='div' />
...
<KittenAsset path='p12s/palladian_grasp_na.webm' wrapper='div' />
...
<KittenAsset path='p12s/uav1_start.webm' wrapper='div' />
...
<table>
    <tr>
        <td><KittenAsset path='p12s/summon_darkness_1.png' /></td>
        <td><KittenAsset path='p12s/summon_darkness_2.png' /></td>
        <td><KittenAsset path='p12s/summon_darkness_3.png' /></td>
    </tr>
</table>
...
<KittenAsset path='p12s/summon_darkness_example.webm' wrapper='div' />
...
<table>
    <tr>
        <th></th>
        <th><KittenAsset path='p12s/geocentrism_donut.webm' /></th>
        <th><KittenAsset path='p12s/geocentrism_vertical.webm' /></th>
        <th><KittenAsset path='p12s/geocentrism_horizontal.webm' /></th>
    </tr>
    <tr>
