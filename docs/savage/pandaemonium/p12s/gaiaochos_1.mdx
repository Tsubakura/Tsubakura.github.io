...
<img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/palladian_grasp_jp.gif' />


</TabItem>
<TabItem value="NA" label="Tankbuster on the east half (Aether)">

The tank invulns at the east half, while the party stays at the west half. This is preferred in Aether.
<img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/palladian_grasp_na.gif' />
...
<img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/uav1_start.gif' />
...
<table>
    <tr>
        <td><img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/summon_darkness_1.png' /></td>
        <td><img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/summon_darkness_2.png' /></td>
        <td><img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/summon_darkness_3.png' /></td>
    </tr>
</table>
...
<img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/missing_link_debuff.png' />
...
<img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/summon_darkness_roles.png' />
...
<img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/summon_darkness_example.gif' />
...
<table>
    <tr>
        <th></th>
        <th><img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/geocentrism_donut.gif' /></th>
        <th><img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/geocentrism_vertical.gif' /></th>
        <th><img src='https://ffxivkittenassets.z7.web.core.windows.net/p12s/geocentrism_horizontal.gif' /></th>
    </tr>
    <tr>
        <th>Elemental <br />Mana</th>
        <td><center>&nbsp;<Role role='MT' />&nbsp;<Role role='ST' /><br /><Role role='H1' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<Role role='H2' /><br /><Role role='D3' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<Role role='D4' /><br />&nbsp;<Role role='D1' />&nbsp;<Role role='D2' /></center></td>
        <td><center><Role role='MT' />&nbsp;&nbsp;&nbsp;<Role role='ST' /><br /><Role role='H1' />&nbsp;&nbsp;&nbsp;<Role role='H2' /><br /><Role role='D3' />&nbsp;&nbsp;&nbsp;<Role role='D4' /><br /><Role role='D1' />&nbsp;&nbsp;&nbsp;<Role role='D2' /></center></td>
        <td><center><Role role='H1' /><Role role='MT' /><Role role='ST' /><Role role='H2' /><br /><Role role='D3' /><Role role='D1' /><Role role='D2' /><Role role='D4' /></center></td>
    </tr>
    <tr>
        <th>Aether</th>
